...
/*
 创建飞机类
 */
function plan(hp,X,Y,sizeX,sizeY,score,dietime,speed,boomimage,imagesrc){
    this.planX=X;
    this.planY=Y;
    this.imagenode=null;
    this.planhp=hp;
...
function enemy(hp,a,b,sizeX,sizeY,score,dietime,speed,boomimage,imagesrc){
    plan.call(this,hp,random(a,b),-100,sizeX,sizeY,score,dietime,speed,boomimage,imagesrc);
}
//产生min到max之间的随机数
...
var yidong=function(){
    ...
    var selfplanY=oevent.clientY - 50;
